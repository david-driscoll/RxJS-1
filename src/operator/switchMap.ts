...
export function switchMap<T, R, TResult>(project: _IndexSelector<T, ObservableInput<R>>): Observable<R>;
export function switchMap<T, R, TResult>(project: _IndexSelector<T, ObservableInput<R>>,
                                         resultSelector: _OuterInnerMapResultSelector<T, R, TResult>): Observable<R>;
export function switchMap<T, R, TResult>(project: _IndexSelector<T, ObservableInput<R>>,
                                         resultSelector?: _OuterInnerMapResultSelector<T, R, TResult>): Observable<R> {
