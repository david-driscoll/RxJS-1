 ...
 */
export function concatMap<T, R>(project: _IndexSelector<T, ObservableInput<R>>): Observable<R>;
export function concatMap<T, R, TResult>(project: _IndexSelector<T, ObservableInput<R>>,
