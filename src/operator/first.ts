...
export function first<T, S extends T>(source: Observable<T>,
                                      predicate: (value: T, index: number, source: Observable<T>) => value is S): Observable<S>;
export function first<T, S extends T, R>(source: Observable<T>,
...
export function first<T>(source: Observable<T>,
                         predicate?: (value: T, index: number, source: Observable<T>) => boolean): Observable<T>;
export function first<T, R>(source: Observable<T>,
 ...
 * @owner Observable
 */
export function first<T, R>(source: Observable<T>, predicate?: (value: T, index: number, source: Observable<T>) => boolean,
