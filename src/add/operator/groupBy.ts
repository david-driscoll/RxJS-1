...
// tslint:disable
import { groupBy as groupByBase } from '../../operator/groupBy';
...
export function groupBy<T, K, R>(this: Observable<T>, keySelector: (value: T) => K,
  ...
  return groupByBase.call(undefined, this, keySelector, elementSelector, durationSelector, subjectSelector);
}
