...
// tslint:disable
import { concat as concatBase } from '../../operator/concat';
 ...
 * @owner Observable
 */
export function concat<T, R>(this: Observable<T>, ...args: any[]): Observable<R> {
  return concatBase.call(undefined, this, ...args);
}
