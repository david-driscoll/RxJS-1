...
// tslint:disable
import { distinctUntilChanged as distinctUntilChangedBase } from '../../operator/distinctUntilChanged';
 ...
 */
export function distinctUntilChanged<T, K>(this: Observable<T>, compare?: (x: K, y: K) => boolean, keySelector?: (x: T) => K): Observable<T> {
  return distinctUntilChangedBase.call(undefined, this, compare, keySelector);
}
