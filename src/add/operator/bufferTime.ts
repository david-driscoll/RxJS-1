...
// tslint:disable
import { bufferTime as bufferTimeBase } from '../../operator/bufferTime';
 ...
 * @owner Observable
 */
export function bufferTime<T>(this: Observable<T>, ...args: any[]): Observable<T[]> {
  return bufferTimeBase.call(undefined, this, ...args);
}
