...
// tslint:disable
import { distinctUntilKeyChanged as distinctUntilKeyChangedBase } from '../../operator/distinctUntilKeyChanged';
...
export function distinctUntilKeyChanged<T>(this: Observable<T>, key: string, compare?: (x: T, y: T) => boolean): Observable<T> {
  return distinctUntilKeyChangedBase.call(undefined, this, key, compare);
}
