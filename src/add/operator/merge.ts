...
// tslint:disable
import { merge as mergeBase } from '../../operator/merge';
 ...
 * @owner Observable
 */
export function merge<T, R>(this: Observable<T>, ...args: any[]): Observable<R> {
  return mergeBase.call(undefined, this, ...args);
}
