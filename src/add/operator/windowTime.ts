...
// tslint:disable
import { windowTime as windowTimeBase } from '../../operator/windowTime';
...
export function windowTime<T>(this: Observable<T>, ...args: any[]): Observable<Observable<T>> {
  return windowTimeBase.call(undefined, this, ...args);
}
